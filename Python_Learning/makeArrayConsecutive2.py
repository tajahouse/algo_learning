...
#     ### What I have figured is that I could just sort the array using the sorted() method before finding the max and min values
...
data = [6, 2, 3, 8] ##So! This basically means I am taking the range of the statues (or how many numbers are in range of the smallest value and the largest value) and subtracting the length of the statues. This will equal how many statues are missing =) 
